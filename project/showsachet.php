...
$sql2 = "SELECT p.*, t.type_name FROM tbl_product AS p JOIN tbl_type AS t ON p.type_id = t.type_id WHERE p.type_id = 4 LIMIT $start, $itemsPerPage"; 
        ...
        <div class="blur">
            <div class="text-center heading-shop">
                ...
                <div class="text-direct">
                    ...
                    <a href="showsachet.php"
                        class="link-dark link-offset-2 link-underline-opacity-0 link-underline-opacity-100-hover">Sachet</a>
                </div>
            </div>
        </div>
    </div>
