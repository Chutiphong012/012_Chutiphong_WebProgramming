...
$sql2 = "SELECT p.*, t.type_name FROM tbl_product AS p JOIN tbl_type AS t ON p.type_id = t.type_id WHERE p.type_id = 1 LIMIT $start, $itemsPerPage"; 
